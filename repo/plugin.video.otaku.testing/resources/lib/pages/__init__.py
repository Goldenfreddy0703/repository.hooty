...
from resources.lib.pages import (
    nyaa, animetosho, nekobt, torrentio, debrid_cloudfiles, easynews,
    animepahe, anikoto, animixplay, hianime, watchnixtoons2, localfiles
)
